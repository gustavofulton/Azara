(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('apollo-client'), require('rxjs/Observable'), require('rxjs/symbol/observable'), require('rxjs/operator/switchMap'), require('rxjs/observable/combineLatest'), require('lodash'), require('rxjs/operator/observeOn'), require('rxjs/scheduler/AsyncAction'), require('rxjs/scheduler/AsyncScheduler')) :
    typeof define === 'function' && define.amd ? define(['exports', 'apollo-client', 'rxjs/Observable', 'rxjs/symbol/observable', 'rxjs/operator/switchMap', 'rxjs/observable/combineLatest', 'lodash', 'rxjs/operator/observeOn', 'rxjs/scheduler/AsyncAction', 'rxjs/scheduler/AsyncScheduler'], factory) :
    (factory((global.apollo = global.apollo || {}, global.apollo.rxjs = global.apollo.rxjs || {}),global.apollo,global.Rx,global.Rx.Symbol,global.Rx.Observable.prototype,global.Rx.Observable,global._,global.Rx.Observable.prototype,global.rxjs_scheduler_AsyncAction,global.Rx.Scheduler.async));
}(this, (function (exports,apolloClient,rxjs_Observable,rxjs_symbol_observable,rxjs_operator_switchMap,rxjs_observable_combineLatest,lodash,rxjs_operator_observeOn,rxjs_scheduler_AsyncAction,rxjs_scheduler_AsyncScheduler) { 'use strict';
...
function createWithObservableVariables(options, mapFn) {
    ...
    return new RxObservableQuery(observableQueryRef, function (subscriber) {
        var sub = rxjs_operator_switchMap.switchMap.call(varObs, (function (newVariables) {
            var cleanOptions = lodash.omit(options, 'variables');
            var newOptions = lodash.assign(cleanOptions, { variables: newVariables });
...
function rxify(clientOrWatchQuery) {
    ...
    if (lodash.isFunction(clientOrWatchQuery)) {
